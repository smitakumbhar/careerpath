                                ...
                                <div class="panel-body">
                                    <div class="jobf">
                                        ...
                                        <?php echo form_open('candidate/'.$action_page);?>
                                         ...
                                         <div class="col-lg-12">
                                            <label for="add" class="col-lg-11"><?= lang("SELECTED_CANDIDATES");?></label> 
                                            <?php 
                                            if(is_array($_SESSION['sess_candidate_array'])){ $count=1;
                                            foreach($_SESSION['sess_candidate_array'] as $key => $value){

                                                ?>

                                                 <?php echo form_hidden('emails[]', $value);?>
                                           <label for="add" class="col-lg-11"> <?= $count;?>)&nbsp;<?= $value;?></label>
                                        <?php  $count++;  }
                                  }?><br>
